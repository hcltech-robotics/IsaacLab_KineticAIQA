...
from . import capture_photo_joint_pos_env_cfg

##
# Pre-defined configs
##
from isaaclab_assets.robots.trossen import TROSSEN_HIGH_PD_CFG  # isort: skip


@configclass
class EventCfg(capture_photo_joint_pos_env_cfg.EventCfg):
    """Configuration for events."""

    randomize_light = EventTerm(
        func=trossen_stack_events.randomize_scene_lighting_domelight,
        mode="reset",
        params={
    ...
    randomize_table_visual_material = EventTerm(
        func=trossen_stack_events.randomize_visual_texture_material,
        mode="reset",
        params={
...
@configclass
class TrossenCubeCapturePhotoVisuomotorEnvCfg(capture_photo_joint_pos_env_cfg.TrossenCubeCapturePhotoEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = TROSSEN_HIGH_PD_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.scene.wrist_cam = CameraCfg(
            prim_path="{ENV_REGEX_NS}/Robot/link_6/wrist_cam",
            update_period=0.0,
            height=200,
            width=200,
