...
from . import capture_photo_ik_rel_visuomotor_env_cfg
...
class ObservationsCfg:
    ...
    class SubtaskCfg(ObsGroup):
        ...
        capture_photo_1 = ObsTerm(
            func=mdp.object_capture_photoed,
            params={
                "robot_cfg": SceneEntityCfg("robot"),
...
@configclass
class TrossenCubeCapturePhotoVisuomotorCosmosEnvCfg(capture_photo_ik_rel_visuomotor_env_cfg.TrossenCubeCapturePhotoVisuomotorEnvCfg):
