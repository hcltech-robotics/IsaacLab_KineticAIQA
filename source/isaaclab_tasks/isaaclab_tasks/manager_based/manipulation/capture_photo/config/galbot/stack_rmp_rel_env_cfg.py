...
##
@configclass
class RmpFlowGalbotRightArmCubeCapturePhotoEnvCfg(stack_joint_pos_env_cfg.GalbotRightArmCubeCapturePhotoEnvCfg):
...
##
@configclass
class RmpFlowGalbotLeftArmCubeStackVisuomotorEnvCfg(RmpFlowGalbotLeftArmCubeCapturePhotoEnvCfg):
...
@configclass
class GalbotLeftArmJointPositionCubeCapturePhotoVisuomotorEnvCfg_PLAY(RmpFlowGalbotLeftArmCubeStackVisuomotorEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
