...
from isaaclab_tasks.manager_based.manipulation.capture_photo.stack_env_cfg import ObservationsCfg, CapturePhotoEnvCfg
...
@configclass
class GalbotLeftArmCubeCapturePhotoEnvCfg(CapturePhotoEnvCfg):
...
@configclass
class GalbotRightArmCubeCapturePhotoEnvCfg(GalbotLeftArmCubeCapturePhotoEnvCfg):
