...
from isaaclab_tasks.manager_based.manipulation.capture_photo.stack_instance_randomize_env_cfg import (
...
@configclass
class FrankaCubeCapturePhotoInstanceRandomizeEnvCfg(CapturePhotoInstanceRandomizeEnvCfg):
