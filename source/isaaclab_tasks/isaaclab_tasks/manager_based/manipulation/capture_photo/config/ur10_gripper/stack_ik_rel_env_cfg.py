...
@configclass
class UR10LongSuctionCubeCapturePhotoEnvCfg(stack_joint_pos_env_cfg.UR10LongSuctionCubeCapturePhotoEnvCfg):
...
@configclass
class UR10ShortSuctionCubeCapturePhotoEnvCfg(stack_joint_pos_env_cfg.UR10ShortSuctionCubeCapturePhotoEnvCfg):
