...
@configclass
class UR10CubeCapturePhotoEnvCfg(CapturePhotoEnvCfg):
...
@configclass
class UR10LongSuctionCubeCapturePhotoEnvCfg(UR10CubeCapturePhotoEnvCfg):
...
@configclass
class UR10ShortSuctionCubeCapturePhotoEnvCfg(UR10CubeCapturePhotoEnvCfg):
